...
<!-- Vendor styles -->
<link rel="stylesheet" href="<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/vendors/material-design-iconic-font/css/material-design-iconic-font.min.css">
<link rel="stylesheet" href="<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/vendors/animate.css/animate.min.css">
<link rel="stylesheet" href="<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/vendors/jquery-scrollbar/jquery.scrollbar.css">
<link rel="stylesheet" href="<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/vendors/fullcalendar/fullcalendar.min.css">
<link rel="stylesheet" href="<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/vendors/lightgallery/css/lightgallery.min.css">
<!-- App styles -->
<link rel="stylesheet" href="<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/css/app.min.css">
<link rel="stylesheet" href="<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/css/add.css">
<link rel="shortcut icon" href="webicon.ico" type="image/x-icon"/>
<link rel="stylesheet" href="<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/css/core.style.css" type="text/css" />
...
<!-- Script
============================================= -->
<script src="<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/vendors/jquery/jquery.min.js"></script>
