      ...
      <div class="col-lg-12">
        <table class="table table-bordered">
            ...
            <tr>
              ...
              <tr>
                <td><?php print __('Student ID'); ?></td>
                <td>{student_id}</td>
              </tr>
              <tr>
                <td><?php print __('Dosen Pembimbing'); ?></td>
                <td>{supervisors}</td>
              </tr>
              <tr>
                <td><?php print __('Penguji'); ?></td>
                <td>{examiners}</td>
              </tr>

              <tr>
                <td><?php print __('Contributor'); ?></td>
                <td>{contributors}</td>
              </tr>

              <tr>
                <td><?php print __('Kode Prodi PDDIKTI'); ?></td>
                <td>{code_ministry}</td>
              </tr>
              <tr>
                <td><?php print __('Data Type'); ?></td>
                <td>{edition}</td>
              </tr>
              <tr>
              ...
              <tr>
                <td><?php print __('Departement'); ?></td>
                <td>{departement}</td>
              </tr>
              <tr>
              ...
              <tr>
                <td><?php print __('Copyright'); ?></td>
                <td>{copyright_name}</td>
              </tr>
              <tr>
                <td><?php print __('Doi'); ?></td>
                <td>{url_crossref}</td>
              </tr>
