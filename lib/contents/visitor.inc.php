...
<div class="container">
    <div class="span8 offset8">
        <div class="visitor" style="text-align: center;">
            ...
            <form action="index.php?p=visitor" name="visitorCounterForm" id="visitorCounterForm" method="post" class="footer hidden-xs-down">
                ...
                <div class="control-group">
                    <div class="controls">
                        <input type="submit" id="counter" name="counter" value="<?php echo __('Add'); ?>" class="btn btn-primary" />
                    </div>
                </div>
    ...
    jQuery(document).ready(function() {
        ...
        visitorCounterForm.ajaxComplete(function() {
            ...
            if (memberImage) {
                ...
                var imageSRC = memberImage.attr('src');
                memberImage.remove();
        ...
        visitorCounterForm.submit(function(evt) {
            ...
            jQuery.ajax({
                ...
                success: function(respond) {
                    ...
                    // reset counter
                    setTimeout(function() {
                        jQuery('#visitorCounterPhoto').attr('src', './images/persons/photo.png');
                        jQuery('#counterInfo').html('&nbsp;');
                    }, 5000);
                }
            });
        });
